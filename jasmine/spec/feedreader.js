...
$(function() {
   ...
   /* TODO: Write a test that ensures the menu element is
        ...
        it('the menu element is hidden by default.', function(){
         expect(container.className).toBe("menu-hidden")
        })

        const menuOne = document.querySelector('.menu-icon-link')

        it('the menu changes visibility when the menu icon is clicked.', function(){
                menuOne.click();
                expect(container.classList.contains("menu-hidden")).toBe(false);
                menuOne.click();
                expect(container.classList.contains("menu-hidden")).toBe(true);
